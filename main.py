...
keyboard = '{"buttons":[[{"action":{"type":"text","label":"Погода","payload":""},"color":"positive"}],[{"action":{"type":"text","label":"Новосибирск","payload":""},"color":"primary"},{"action":{"type":"text","label":"Красноярск","payload":""},"color":"primary"}],[{"action":{"type":"text","label":"Бердск","payload":""},"color":"primary"},{"action":{"type":"text","label":"Кольцово","payload":""},"color":"primary"}],[{"action":{"type":"text","label":"Казань","payload":""},"color":"primary"},{"action":{"type":"text","label":"Омск","payload":""},"color":"primary"}]]}'
